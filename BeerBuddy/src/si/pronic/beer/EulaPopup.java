...
{
	public EulaPopup(String titleValue, String textValue, String buttonName)
	{
		...
		acceptButton.setChangeListener(new FieldChangeListener() 
		{
			...
			{
    	        PersistentObject persist = PersistentStore.getPersistentObject(BeerBuddy.PERSISTANCE_ID);
